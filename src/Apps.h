...
// 覆盖层函数声明
void NotifyOverlay(FastLED_NeoMatrix* matrix, MatrixDisplayUiState* state, FastFramePlayer *player);
void SpectrumOverlay(FastLED_NeoMatrix* matrix, MatrixDisplayUiState* state, FastFramePlayer *player);
void AlarmOverlay(FastLED_NeoMatrix* matrix, MatrixDisplayUiState* state, FastFramePlayer *player);
void TimerOverlay(FastLED_NeoMatrix* matrix, MatrixDisplayUiState* state, FastFramePlayer *player);
